...
function EventsPage() {
  ...
  const handleRegister = async (eventId) => {
    ...
    setMessage('Event registration completed.');
    loadEvents();
  };
  ...
  return (
    <div className="page-stack">
      <section className="hero-card">
        <div>
          <p className="eyebrow">Step 3: plan ahead</p>
          <h1>Register once and let reminders keep you prepared.</h1>
          <p className="muted-text">
            This flow maps to the `registrations` table, where each user-event pair also stores reminder preferences.
          </p>
        </div>
